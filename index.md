  ...
  <body data-spy="scroll" data-target="#navbar">
    	...
    	<nav class ="navbar navbar-fixed-top navbar-inverse" id="navbar">
	  		<div class="container">
				...
				<div class="navbar-header">							
					...
					<a class="navbar-brand" href="indx.html">1nf1corp.io</a>
				</div><!-- navbar-header -->	
   		...
   		<div class="cover" id="home">
	  		<div class="cover-text">
				...
				<p class="lead">We're the "coolest" Tech Startup in Africa</p>
	  	...
	  	<section class="testimonial">
			<div class="container">
				<blockquote>
					&ldquo; I never realized how much we were losing to faulty and unaudited systems I just cant believe my eyes. Its not too late, highly recommended ! &rdquo;
					<cite>&mdash; Anonymous Company, a happy client</cite>
				</blockquote>
			</div>
	  	</section>
	  
	  	<section id="why-us" >
	  		<h2>Why 1nf1corp.io ?</h2>
	  			<div class="container">
					<div class="row">
						<div class="col-sm-4">
							<h3>Artisanal</h3>
		  ...
		  <div class="container">
			<div class="row">
				<div class="col-sm-3">
					...
					<h4>Anastasia</h4>
					<p>Female Tech Maker,CCO</p>	
				</div>
				
				<div class="col-sm-3">
					<img src="img/john.jpg" alt="Man's face" class="img-circle">
					<h4>1nf1D3L</h4>
					<p>Data Scientist, Systems Analyst, Founder, CTO.</p>	
				</div>
				...
				<div class="col-sm-3">
					...
					<h4>Eric Ndirangu</h4>
					<p>Problem Solver , Data Scientist , CIO</p>	
				</div>
	 ...
	 <section id="signup">
	  	<div class="container">
			...
			<p class="lead">We'll send you about our latest updates, trippy tech and current trends!</p>
			<div class="row">
	  ...
	  <footer>
	  		crafted with &hearts; in calgary by <a href="williammajanja@gmail.com">C0d3R4mm3r</a>
	  </footer>
